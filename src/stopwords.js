  ...
  const PRESETS = [
    ...
    },
    {
      ...
      words: [
        ...
        "분석했다", "진단했다", "호소했다", "촉구했다", "요구했다",
        "나타났다", "조사됐다", "집계됐다", "개선됐다", "확인됐다",
        "전망된다", "분석된다", "예상된다", "관측된다", "풀이된다",
        "늘었다", "줄었다", "올랐다", "내렸다", "떨어졌다", "높아졌다",
        "낮아졌다", "커졌다", "작아졌다", "나빠졌다", "좋아졌다",
        "이어졌다", "그쳤다", "멈췄다", "기록했다", "차지했다", "이끌었다",
        "달성했다", "나선다", "나온다", "이어진다", "커진다", "줄어든다",
        "있다", "없다", "같다", "크다", "높다", "낮다", "많다", "적다",
      ],
    },
    {
      id: "units",
